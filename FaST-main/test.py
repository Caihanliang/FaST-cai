...
# ========== 配置 ==========
CFG_PATH = 'FaST-main/main-master/FaST/HNGS_96_48.py'
...
df = pd.read_hdf('FaST-main/DataPipeline/HNGS/hngs_his_2023.h5')
idx_test = np.load('FaST-main/main-master/datasets/HNGS/96_48/idx_test.npy')
